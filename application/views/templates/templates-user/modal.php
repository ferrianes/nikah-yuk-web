  				...
  				<form class="user" method="post" action="<?= base_url('customer/daftar'); ?>">
  					<div class="modal-body">
  						...
  						<div class="form-group">
  							<input type="text" class="form-control form-control-label" id="username" name="username"
  								placeholder="Username">
  						</div>

  						<div class="form-group">
  							<input type="text" class="form-control form-control-label" id="nm_lengkap"
  								name="nm_lengkap" placeholder="Nama Lengkap">
  						</div>

  						<div class="form-group">
  							<input type="text" class="form-control form-control-label" id="alamat" name="alamat"
  								placeholder="Alamat Lengkap">
  						</div>

  						<div class="form-group">
  							<input type="text" class="form-control form-control-label" id="email" name="email"
  								placeholder="Alamat Email">
  						</div>

  						<div class="form-group">
  							<input type="text" class="form-control form-control-label" id="telepon" name="telepon"
  								placeholder="Telepon">
  						</div>

  						<div class="form-group">
  							<input type="password" class="form-control form-control-label" id="password1"
  								name="password1" placeholder="Password">
  						</div>

  						<div class="form-group">
  							<input type="password" class="form-control form-control-label" id="password2"
