...
<?php if ($judul == 'Tambah Ke Booking')  : ?>
<!-- Modal Hapus Menu Baru -->
<div class="modal fade" id="modalKonfirmasiHapusKeranjang" tabindex="-1" aria-labelledby="modalKonfirmasiHapusKeranjangLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-warning" id="modalKonfirmasiHapusKeranjangLabel">Hapus Produk Dari Keranjang</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form method="post" action="<?= base_url('menu') ?>">
                <div class="modal-body text-dark">
                    <p>Anda yakin untuk menghapus Produk ini dari keranjang anda?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <a href="" class="btn btn-warning btn-ok">Hapus</a>
                </div>
            </form>
        </div>
    </div>
