					...
					<div class="col-md-6 col-sm-12">
						...
						<div class="text-center mb-2">
							<img class="img-thumbnail thumb"
								src="<?= base_url('assets/img/api/products/' . $thumbnail['gambar']) ?>" alt="slide ke-1">
						</div>
						<?php else : ?>
						<!-- Carousel -->
							...
							<div class="carousel-inner">
								...
								<div class="carousel-item">
									...
									<video autoplay loop muted class="w-100 thumb-video">
										<source src="<?= base_url('assets/img/api/products/') . $produk_gambar['gambar'] ?>"
											type="video/<?= $file_parts['extension'] ?>">
										Your browser does not support HTML video.
									</video>
									<?php else : ?>
									<img class="d-block w-100 thumb"
										src="<?= base_url('assets/img/api/products/') . $produk_gambar['gambar'] ?>"
										alt="slide ke-<?= $i; ?>">
									<?php endif; ?>
								</div>
								<?php $i++; endforeach; ?>
